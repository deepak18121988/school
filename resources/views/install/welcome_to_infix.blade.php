...
<head>
    ...
    <link rel="alternate" href="https://grpro.in" hreflang="en-us" />
    <title>GR Security AI-Powered School Management System | School ERP</title>
        ...
        <div class="card">
            ...
            <div class="single-report-admit">
                <div class="card-header">
                    <h2 class="text-center text-uppercase" style="color: whitesmoke">Welcome to GRpro </h2>
                
                </div>
            </div>

            <div class="card-body">
                  <p style="text-align: center">Thank you for choosing GRpro for your school administration. Please follow the steps to complete GRpro installation!</p>
