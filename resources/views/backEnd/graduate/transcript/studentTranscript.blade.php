                                    ...
                                    <td>
                                        <div class="transcript_print d_flex gap_20">
                                            <div class="transcript_print_left flex_fill d_flex gap_20">
                                                ...
                                                <div class="">
                                                    <h4>{{isset(generalSetting()->school_name)?generalSetting()->school_name:'GRpro School Management ERP'}}</h4>
                                                    <h5>{{isset(generalSetting()->address)?generalSetting()->address:'GRpro School Address'}}</h5>
                                                    <h5>{{isset(generalSetting()->email)?generalSetting()->email:'info@grpro.in'}}</h5>
                                                    <h5>{{isset(generalSetting()->phone)?generalSetting()->phone:'+919513476201'}}</h5>
                                                </div>
                                            </div>
                                        </div>
                                    </td>
