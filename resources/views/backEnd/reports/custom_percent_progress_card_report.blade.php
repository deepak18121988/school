                                            ...
                                            <div class="card-header">
                                                    <div class="d-flex">
                                                            ...
                                                            <div class="col-lg-8 text-center">
                                                                ...
                                                                <p class="text-white mb-0"  style="font-size: 16px;">
                                                                    @lang('common.email'):  {{isset(generalSetting()->email)?generalSetting()->email:'hello@aorasoft.com'}},   @lang('common.phone'):  {{isset(generalSetting()->phone)?generalSetting()->phone:'+919513476201'}}
                                                                </p>
                                                            </div>
                                                        </div>
