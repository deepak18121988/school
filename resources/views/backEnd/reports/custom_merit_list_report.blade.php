                                    ...
                                    <div class="card-header">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="col-lg-6 ml-30">
                                                ...
                                                <p class="text-white mb-0"> @lang('common.email')  {{isset($email)?$email:'info@grpro.in'}} ,  @lang('common.phone')  {{isset(generalSetting()->phone)?generalSetting()->phone:'info@grpro.in'}} </p> 
                                            </div>
                                            <div class="offset-2">
