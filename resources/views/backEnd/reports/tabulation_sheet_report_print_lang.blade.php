                                    ...
                                    <td>
                                        <div class="logo_img">
                                            ...
                                            <div class="company_info">
                                                ...
                                                <h5>{{isset(generalSetting()->address)?generalSetting()->address:'GRpro School Address'}}</h5>
                                                <h5>@lang('common.email'): {{isset(generalSetting()->email)?generalSetting()->email:'info@grpro.in'}}, @lang('common.phone'): {{isset(generalSetting()->phone)?generalSetting()->phone:'+919513476201'}}</h5>
                                            </div>
                                        </div>
                                    </td>
                                </thead>
                                ...
                                <td>
                                    <div class="logo_img">
                                        ...
                                        <div class="company_info">
                                            <h3>{{isset(generalSetting()->school_name)?generalSetting()->school_name:'GRpro School Management ERP'}}</h3>
                                            <h5>{{isset(generalSetting()->address)?generalSetting()->address:'GRpro School Address'}}</h5>
                                            <h5>@lang('exam.email'): {{isset(generalSetting()->email)?generalSetting()->email:'info@grpro.in'}}, @lang('exam.phone'): {{isset(generalSetting()->phone)?generalSetting()->phone:'+919513476201 '}}</h5>
                        </div>
                        <div class="invoice_wrapper fullwidth_90">
                            <div class="invoice_print mb_30">
                                <div class="container">
