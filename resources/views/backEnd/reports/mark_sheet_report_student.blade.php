                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-xl-8  col-sm-8 text-center">
                                                                ...
                                                                <p class="text-white mb-0" style="font-size: 16px;">
                                                                    @lang('common.email'): <span class="text-lowercase">{{isset(generalSetting()->email)?generalSetting()->email:'info@grpro.in'}}</span>,
                                                                    @lang('common.phone'): {{isset(generalSetting()->phone)?generalSetting()->phone:'+919513476201'}} </p>
                                                            </div>
