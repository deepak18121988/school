        ...
        <div class="container-fluid" id="pdf"> 
                    ...
                    <table  cellspacing="0" width="100%">
                        <tr>
                            ...
                            <td> 
                                <h3 style="font-size:22px !important" class="text-white"> {{isset(generalSetting()->school_name)?@generalSetting()->school_name:'GRpro School Management ERP'}} </h3> 
                                <p style="font-size:18px !important" class="text-white mb-0"> {{isset(generalSetting()->address)?@generalSetting()->address:'GRpro School Address'}} </p> 
