...
return [
    ...
    'fields' => [
        ...
        [
            ...
            'type'          => 'editor',
            'value'         => "Make school tasks easy! With GRpro School Management Software, teachers can quickly handle attendance and grades. It helps teachers do their jobs better so they can focus on helping students succeed.",
            'class'         => '',
