@php $page_title="All about GRpro School management system; School management software"; @endphp
                                                        ...
                                                        <div class="d-flex">
                                                            ...
                                                            <div class="col-lg-8 text-center">
                                                                <h3 class="text-white"
                                                                    ...
                                                                    {{ isset(generalSetting()->school_name) ? generalSetting()->school_name : 'Grpro School Management ERP' }}
                                                                </h3>
                                                                <p class="text-white mb-0" style="font-size: 16px;">
                                                                    {{ isset(generalSetting()->address) ? generalSetting()->address : 'GRpro School Address' }}
                                                                </p>
                                                                <p class="text-white mb-0" style="font-size: 16px;">
                                                                    @lang('common.email'): <span
                                                                        class="text-lowercase">{{ isset(generalSetting()->email) ? generalSetting()->email : 'info@grpro.in' }}</span>,
                                                                    @lang('common.phone'):
                                                                    {{ isset(generalSetting()->phone) ? generalSetting()->phone : '+919513476201' }}
                                                                </p>
                                                            </div>
                                                        </div>
