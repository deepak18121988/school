...
<head>
    ...
    <title>{{ $setting->site_title ? $setting->site_title : 'GRpro ERP' }}</title>
                ...
                <div class="container box-1420">
                    ...
                    <a class="navbar-brand" href="{{ url('/') }}/home">
                        <img class="w-75"
                            ...
                            alt="GRpro Logo" style="max-width: 150px;">
                    </a>
            ...
            <div class="row single-footer-widget">
                <div class="col-lg-8 col-md-9">
                    <div class="copy_right_text">
                        ...
                        @else
                            Copyright © 2019 All rights reserved | This application is made with by GRpro
                        @endif
                    </div>
                </div>
