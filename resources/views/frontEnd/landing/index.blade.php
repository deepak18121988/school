...
<head>
    ...
    <title> GRpro school management software & School management system </title>
    <meta name="description" content="GRpro is 100+ unique feature enable school management software system. It can manage all type of school, academy and any educational institution. ">
    ...
    <script type="application/ld+json">
        [ {
          ...
          "name" : "GRpro - Best School Management software system",
          "url" : "https://grpro.in/",
          "author" : {
            "@type" : "Company",
            "name" : "Spondon IT"
          ...
          "downloadUrl" : "https://grpro.in",
          "operatingSystem" : "2019",
          "requirements" : "in a complete",
          "screenshot" : "https://grpro.in/public/landing/img/dashboard_preview.png",
          "softwareVersion" : "2.0",
    ...
    <meta name="twitter:site" content="@GRpro"/>
    <meta name="twitter:creator" content="@GRpro"/>
    <meta name="twitter:url" content="//grpro.in/"/>
    <meta name="twitter:title" The Ultimate Education Management System For School,  Institute & Academy"/>
    <meta name="twitter:description" content="GRpro is a well known School management system and its ERP based Software. So try the free demo today!. Cause GRpro offers 100+  featured, well-documented and latest academic management software system.. By this multipurpose software system, you can easily manage your school,  university or any kind of organization educational institute. So we can provide you speedy, Secure and clean coded Flexible academy and school management system at affordable prices!"/>
    <meta property="og:image" content="https://grpro.in/public/landing/img/dashboard_preview.png"/>


    <!-- Open Graph data -->
    <meta property="og:type" content="website" />
    <meta property="og:url" content="//grpro.in"/>
    <meta property="og:image" content="//grpro.in/public/landing/img/dashboard_preview.png"/>
    <meta property="og:title" content="School Management ERP Software & School Management System - GRpro"/>

    <meta property="og:description" content="GRpro is a well known School management system and its ERP based Software. So try the free demo today!. Cause GRpro offers 100+  featured, well-documented and latest academic management software system.. By this multipurpose software system, you can easily manage your school,  university or any kind of organization educational institute. So we can provide you speedy, Secure and clean coded Flexible academy and school management system at affordable prices!"/>
    <meta property="og:site_name" content="GRpro" />

    <link rel="canonical" href="https://grpro.in" hreflang="en-us" />
                ...
                <div class="banner_text">
                    <div class="banner_text_iner">
                        ...
                        <p>Managing various administrative tasks in one place is now quite easy and time
                            savior with this GRpro and Give your valued time to your institute that will
                            increase next generation productivity for our society.</p>
                        @if(!moduleStatusCheck('Saas'))
                            <a  class="btn_1" target="_blank" href="mailto:info@grpro.in?subject=Request for GRpro SaaS Application Demo!&body=Could you please arrange a demo for the GRpro SaaS application at your earliest convenience?"> <i class="ti-email"></i> For Saas Demo</a>
                        @endif
            ...
            <div class="col-sm-6 col-xl-3">
                <div class="single_feature">
                    <div class="single_feature_part">
                        ...
                        <p>GRpro has all in one place. You’ll find everything what you are looking into education
            ...
            <div class="col-sm-6 col-xl-3">
                <div class="single_feature">
                    <div class="single_feature_part">
                        ...
                        <p>You know! Smart Idea always comes to well planners. And Our GRpro is Smart for its Well
                            Documentation.
                        </p>
                    </div>
                </div>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-5 col-lg-5">
                <div class="video_section_text">
                    <h2>Take A look Our GRpro Overview in Video</h2>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-xl-6 col-md-8">
                <div class="section_tittle text-center">
                    <h5>AMazing Features</h5>
                    <h2>More Features Has GRpro</h2>
                    <p>it's vast! GRpro has more additional feature that will expect in a complete solution.</p>
                </div>
            </div>
        </div>
        <div class="row justify-content-center">
...
<section class="contact_us padding_top" id="Support">
    <div class="container">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-6">
                <a href="https://grpro.in" target="_blank">
                    <div class="single_feature">
                        <div class="single_feature_part">
            ...
            <div class="col-md-6">
                <a class="support-link" target="_blank" href="https://grpro.in">
                    <div class="single_feature">
                        <div class="single_feature_part">
                            <span class="single_feature_icon"><i class="ti-write"></i></span>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="footer_area_text">
                    ...
                    <p>We Believe! It won’t a wrong decision in Purchasing our GRpro for your Institute.</p>
                   
                    <a href="https://aorasoft.com" target="_blank" class="footer_btn"> <i class="ti-shopping-cart-full"></i>
                        <h3>Purchase GRpro</h3>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="copyright_text">
                    <p> <img src="{{asset('public/landing/img/copyright.svg')}}" alt="#"> 2019-2020 GRpro - Ultimate Education ERP. All Rights
...
<a class="whatsApp_icon" style="background-color: #359334" href="https://wa.me/+919513476201" target="_blank">
