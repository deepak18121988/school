            ...
            for($i=2; $i<=5; $i++){
                ...
                DB::table('sm_testimonials')->insert([
                    [
                        ...
                        'description' => 'its vast! GRpro has more additional feature that will expect in a complete solution.',
                ...
                for ($role_id = 4; $role_id <10; $role_id++) {
                    ...
                    $newUser->email     = $First_Name . $j . '@grpro.in';
                    $newUser->username  = $First_Name . $j . '@grpro.in';
                ...
                for ($j = 1; $j <= 20; $j++) {
                                ...
                                $studentEmail = strtolower($student_User_Name) . $j . '@grpro.in';
                                ...
                                $newUser->email     = strtolower($Father_User_Name).'_pa' . $j . '@grpro.in';
                                $newUser->username  = strtolower($Father_User_Name).'_pa' . $j . '@grpro.in';
                                $newUser->password  = Hash::make(123456);
                                ...
                                $parent->guardians_email      = $Guardian_First_Name . $j . '@grpro.in';
