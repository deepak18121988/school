...
class SmNewsSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $staticNews = [
            [
                'title' => "Digital Transformation in Education: GRpro Paving the Way",
                'body' => "GRpro is leading the charge in digital transformation, revolutionizing the way education is delivered. With cloud-based solutions and real-time data analytics, GRpro enables institutions to streamline operations, enhance student engagement, and foster a culture of innovation. This shift not only modernizes the classroom but also prepares students for a digital-first world.",
            ],
            [
                'title' => "Success Stories: How GRpro ERP Empowers Schools Worldwide",
                'body' => "GRpro's ERP system has empowered schools across the globe to transform their administration and academic processes. By simplifying management, enhancing communication, and improving resource allocation, GRpro has helped schools deliver better educational experiences. Schools in multiple countries report increased efficiency, reduced costs, and greater student satisfaction thanks to this robust ERP solution.",
            ],
            [
                'title' => "GRpro Launches Enhanced Features for a Seamless School Year",
                'body' => "The new features launched by GRpro are designed to support schools in creating a seamless and productive academic year. From updated enrollment tools and attendance tracking to advanced reporting capabilities, these enhancements offer educators and administrators more control and insight than ever before, driving educational success across all levels.",
            ],
            [
                'title' => "Innovations in School Management: The Future of GRpro",
                'body' => "GRpro is pioneering innovations in school management, incorporating AI-driven analytics and mobile-friendly platforms that make educational management more efficient and data-informed. These advancements empower educators and administrators to manage resources, track student performance, and optimize curricula with unprecedented ease, setting new standards in education technology.",
            ]
        ];
