    ...
    public function run(): void
    {
        ...
        DB::table('sm_events')->insert([
            [
                ...
                <div style='text-align: justify;'>For more details and registration, contact +919513476201.</div>",
            ...
            [
                ...
                <div style='text-align: justify;'>For more details or any queries, contact +919513476201.</div>",
