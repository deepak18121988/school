        ...
        foreach($datas as $key => $data){
            ...
            DB::table('speech_sliders')->insert([
                [
                    ...
                    'designation' => $data,
                    'speech' => "GRpro is a traditional and reputed school, the students use their talents to develop creative spirit in creating skilled citizens, and the light of education has shown people the way of life.",
