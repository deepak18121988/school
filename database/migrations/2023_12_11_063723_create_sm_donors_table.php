...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        $datas = [
            ...
            [' Virat Kohli ', 'Farmer', date("Y-m-d", strtotime('1993-08-05')), "virat@grpro.in", '+91 123456789', $bloodgroup->id, $religion->id, $gender->id],
            ['Dinesh Kumar', 'Engineer', date("Y-m-d", strtotime('1990-12-12')), "dkumar@grpro.in", '+91 123456789', $bloodgroup->id, $religion->id, $gender->id],
        ];
        ...
        foreach($datas as $key => $data){
            ...
            $storeData->current_address = "Indore, India";
            $storeData->permanent_address = "Indore, India";
