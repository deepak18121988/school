...
class CreateSmGeneralSettingsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('sm_general_settings', function (Blueprint $table) {
            ...
            $table->string('system_version')->nullable()->default('8.2.8');
        ...
        DB::table('sm_general_settings')->insert([
            [
                'copyright_text' => "Copyright © " . date('Y') . " All rights reserved | This application is made with by GRpro",
                ...
                'currency' => 'INR',
                'currency_symbol' => '₹',
                'school_name' => 'GRpro School',
                'site_title' => 'GR Security AI-Powered School Management System',
                'session_id' => 1,
                'week_start_id' => 3,
                'time_zone_id' => 51,
